...
\synsym{universal-character-name}
  \synprd{\texttt{\bslh{}u} \textit{hex-quad}}
  \synprd{\texttt{\bslh{}U} \textit{hex-quad hex-quad}}
...
\synsym{header-name}
  ...
  \synprd{\texttt{\qdbl} \textit{h-char-sequence} \texttt{\qdbl}}
...
\synsym{q-char}
  \synprd[]{除新行和\texttt{\qdbl}以外的任何源字符集成员}
...
\synsym{pp-number}
  ...
  \synprd{\textit{pp-number} \texttt{\qsgl} \textit{digit}}
  \synprd{\textit{pp-number} \texttt{\qsgl} \textit{nondigit}}
...
\synsym{binary-literal}
  ...
  \synprd{\texttt{0B} \textit{binary-digit}}
  \synprd{\textit{binary-literal} \texttt{\qsgl}\textit{$_{opt}$ binary-digit}}
\synsym{octal-literal}
  \synprd{\texttt{0}}
  \synprd{\textit{octal-literal} \texttt{\qsgl}\textit{$_{opt}$ octal-digit}}
\synsym{decimal-literal}
  \synprd{\textit{nonzero-digit}}
  \synprd{\textit{decimal-literal} \texttt{\qsgl}\textit{$_{opt}$ digit}}
...
\synsym{hexdecimal-digit-sequence}
  ...
  \synprd{\textit{hexdecimal-digit-sequence} \texttt{\qsgl}\textit{$_{opt}$
                  hexdecimal-digit}}
...
\synsym{character-literal}
  \synprd{\textit{encoding-prefix$_{opt}$}
          \texttt{\qsgl} \textit{c-char-sequence} \texttt{\qsgl}}
...
\synsym{c-char}
  \synprd{除单引号\texttt{\qsgl}、反斜杠\texttt{\bslh}和新行字符以外的源字符集成
          员}
...
\synsym[one of]{simple-escape-sequence}
  \synprd{\texttt{\bslh\qsgl\ \bslh\qdbl\ \bslh?\ \bslh\bslh}}
  \synprd{\texttt{\bslh a \bslh b \bslh f \bslh n \bslh r \bslh t \bslh v}}
\synsym{octal-escape-sequence}
  \synprd{\texttt{\bslh} \textit{octal-digit}}
  \synprd{\texttt{\bslh} \textit{octal-digit octal-digit}}
  \synprd{\texttt{\bslh} \textit{octal-digit octal-digit octal-digit}}
\synsym{hexadecimal-escape-sequence}
  \synprd{\texttt{\bslh x} \textit{hexadecimal-digit}}
...
\synsym{digit-sequence}
  \synprd{\textit{digit}}
  \synprd{\textit{digit-sequence} \texttt{\qsgl}\textit{$_{opt}$ digit}}
...
\synsym{s-char}
  \synprd{除双引号\texttt{\qdbl}、反斜杠\texttt{\bslh}或新行字符以外
          的源字符集成员}
  \synprd{\textit{escape-sequence}}
  \synprd{\textit{universal-character-name}}
\synsym{raw-string}
  \synprd{\texttt{\qdbl} \textit{d-char-sequence$_{opt}$} \texttt{(}
...
\synsym{d-char}
  \synprd{除空格、左括号\texttt{(}、右括号\texttt{)}、反斜杠\texttt{\bslh}和表示
          水平制表、垂直制表、换页和新}
